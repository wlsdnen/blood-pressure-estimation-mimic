...
from mimic_cnn_multichannel_class import SignalCNN
...
x_data = dh.MergeChannelData(x1=x_data1, x2=x_data2)
print (x_data)

print (x_data.shape)

sess = tf.Session()
cnn = SignalCNN(signal_length=125, num_outputs=2, filter_sizes=[2], num_filters=64)
